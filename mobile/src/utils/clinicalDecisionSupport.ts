...
export function evaluateGuardian(text: string, patient?: any): GuardianFlag[] {
...
export function followUpQuestions(text: string, patient?: any) {
  const lower = text.toLowerCase();
...
export function buildReferralLetter({ patient, transcript, assessment }: { patient?: any; transcript?: string; assessment?: any }) {
...
export function medicineSafetyMessages(patient?: any) {
